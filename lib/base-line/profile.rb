module Mass 
    class Profile < BlackStack::Base
        ...
        def child_class_instance
            ...
            raise "Source code of profile type #{profile_type} not found. Create a class #{key} in the folder `/models/stub` and require it from `/lib/stubs`." unless Kernel.const_defined?(key)
